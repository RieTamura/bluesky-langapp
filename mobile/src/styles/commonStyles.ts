...
export const commonStyles = StyleSheet.create({
  ...
  statusBox: { flex: 1, padding: 12, borderRadius: 10, alignItems: 'center' },
  statusLabel: { fontSize: 12, fontWeight: '600' },
  statusNumber: { fontSize: 20, fontWeight: '800', marginTop: 6 },
  // chartContainer rendered inside the outer card; remove its border to keep flat appearance
  chartContainer: { padding: 12, borderRadius: 10, marginBottom: 12 },
  ...
  ,card: { padding: 12, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, marginBottom: 16 }
});
